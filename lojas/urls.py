...
from lojas.views import index_lojas, details, pedido, del_pedido, del_carrinho, finaliar_compra, confirma_compra, acompanhar_pedidos, desativa_pedidos, painel_loja
from . import views
...
urlpatterns = [
    ...
    path('painelLoja/', painel_loja, name='painel_loja')
]